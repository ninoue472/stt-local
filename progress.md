# Sprint: コードレビュー指摘の堅牢化（Top3）  — Todo
...
| ID    | タスク                                                | 状態 | 担当 | PR  |
|-------|-------------------------------------------------------|------|------|-----|
| T-031 | 空テキスト時のクリップボード上書き＆誤トーストを止める     | Review | Codex | #13 |
| T-032 | prewarmWhisper の多重実行を直列化（再試行/モデル切替競合）  | Todo   | —     | —   |
...
- 各タスクに受け入れ条件素案あり（`docs/tasks/TODO/T-031.md`〜`T-033.md`）。
